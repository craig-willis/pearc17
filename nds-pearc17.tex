...
Labs Workbench provides a scalable, resource-constrained, and low-barrier approach to supporting access to data hosted on research and HPC systems. This and other container-based analysis environments are opening up new opportunities to support access to large-scale data.  DataDNS will connect traditional discovery methods, such as institutional and community repositories, to remotely hosted data to further enable re-use.
...
The work discusses the ROGER supercomputer, which is supported by NSF under grant number: 1429699.
